...
class SampleIntegrationTest extends BaseIntegrationTest {
    ...
    void createSample() {
        ...
        var response = rest.exchange("/api/samples", HttpMethod.POST,
                authHeader(token, request), SampleResponse.class);
    ...
    void listSamples() {
        ...
        var response = rest.exchange("/api/samples", HttpMethod.GET,
                authHeader(token), new ParameterizedTypeReference<List<SampleResponse>>() {});
    ...
    void getSampleById() {
        ...
        var created = rest.exchange("/api/samples", HttpMethod.POST,
                authHeader(token, request), SampleResponse.class).getBody();
        assertThat(created).isNotNull();

        var response = rest.exchange("/api/samples/{id}", HttpMethod.GET,
                authHeader(token), SampleResponse.class, created.id());
    ...
    void getSampleById_notFound() {
        ...
        var response = rest.exchange("/api/samples/{id}", HttpMethod.GET,
                authHeader(token), Void.class, id);
